...
const founders = [
    {
        ...
        image: "/images/founders/vikas-anand-a.png",
        bio: "Leads Willow Casa with a strong vision for integrated architecture, interiors, and turnkey solutions, focusing on design excellence, functionality, and seamless project delivery.",
        linkedin: "#",
        accentColor: "#c8a96e",
        tag: "Vision & Strategy",
    },
    {
        name: "Gaurav Anand",
        role: "Director",
        image: "/images/founders/gaurav-anand.jpg",
        bio: "Drives strategic growth and operations, ensuring efficient execution and high-quality delivery while strengthening client relationships across diverse projects.",
        linkedin: "#",
        accentColor: "#9e7c5a",
        tag: "Growth & Ops",
    },
    {
        ...
        image: "/images/founders/ajay-singh-a.png",
        bio: "Oversees project execution and construction management, ensuring timely delivery, quality control, and seamless coordination between design and on-site operations.",
        linkedin: "#",
        accentColor: "#b5975e",
        tag: "Execution",
    },
...
function FounderCard({ founder, index }) {
    ...
    return (
        ...
        >
            ...
            <div className="relative overflow-hidden rounded-2xl aspect-[4/5] mb-6"
                ...
                <div
                    style={{
                        ...
                        background: `radial-gradient(circle at top right, ${founder.accentColor}55, transparent 70%)`,
                        zIndex: 2,
                        pointerEvents: "none",
                    }}
                />
                ...
                <div className="absolute inset-0 transition-opacity duration-500"
                    style={{
                        background: `linear-gradient(to top, ${founder.accentColor}66 0%, transparent 55%)`,
                        opacity: 0,
                    }}
                />
                ...
                <div className="absolute top-4 left-4 w-9 h-9 rounded-full flex items-center justify-center"
                    ...
                    <span className="text-xs font-semibold tracking-widest" style={{ color: founder.accentColor }}>
                        0{index + 1}
                    </span>
                </div>

                {/* Specialty tag – bottom right */}
                <div className="absolute bottom-4 right-4 px-3 py-1 rounded-full text-[10px] tracking-widest uppercase font-medium"
                    style={{
            ...
            <motion.div
                variants={lineReveal}
                className="origin-left h-px mb-4"
                style={{ background: `linear-gradient(to right, ${founder.accentColor}, transparent)` }}
            />

            {/* Info */}
            <div className="flex flex-col gap-1 flex-1">
                <p className="text-xs tracking-[0.22em] uppercase font-medium" style={{ color: "#b09070" }}>
                    {founder.role}
                </p>
    ...
    return (
        <>
            ...
            <style>{`
                ...
                /* Shimmering border on card hover */
                .founder-glow {
                    transition: box-shadow 0.5s ease;
                }
                .founder-glow:hover {
                    box-shadow: 0 0 0 1px rgba(200,169,110,0.35), 0 24px 60px -12px rgba(158,124,90,0.2);
                }
            ...
            <section style={{ background: "#f7f4ef" }} className="font-sans pt-36 relative overflow-hidden">
                ...
                {/* ── BACKGROUND AMBIENT ORBS (founders section) ── */}
                ...
                <AnimatedSection className="max-w-6xl mx-auto px-6 lg:px-12 mb-10 relative z-10">
                    <div className="flex items-start justify-between flex-wrap gap-8">
                        <div className="max-w-xl">
                            ...
                            >
                                Meet our
                                <span className="block italic font-normal" style={{ color: "#c8a96e" }}>founders.</span>
                            </motion.h2>
                        </div>
                        ...
                        <div className="max-w-xs self-end pb-2 relative">
                            ...
                            >
                                Three leaders. One shared vision — designing and delivering
                                spaces that are timeless, functional, and built to last.
                            </motion.p>
                        </div>
                    </div>
                </AnimatedSection>
                ...
                {/* ── FOUNDERS GRID ── */}
                <div className="max-w-6xl mx-auto px-6 lg:px-12 mb-32 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14">
                        {founders.map((founder, i) => (
                            <div key={founder.name} className="founder-glow rounded-2xl">
                            ...
                            <div>
                                ...
                                >
                                    <div className="w-12 h-12 rounded-full overflow-hidden"
                                        style={{ boxShadow: "0 0 0 1px rgba(200,169,110,0.35), 0 0 0 4px rgba(200,169,110,0.08)" }}>
                                        <Image
                                            src="/images/founders/vikas-anand-a.png"
                                            alt="Vikas Anand"
                                            width={500}
                                            height={500}
                                    ...
                                    <div>
                                        <p className="font-medium" style={{ color: "#e8ddd0" }}>Vikas Anand</p>
                                        <p className="text-xs tracking-widest uppercase" style={{ color: "#7a6a58" }}>Managing Director</p>
                                    </div>
