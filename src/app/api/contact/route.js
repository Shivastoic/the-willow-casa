...
//   SMTP_TO=Vikas@willowcasa.in        ← where enquiries land
...
<head>
  ...
  <title>New Enquiry — Willow Casa</title>
</head>
    ...
    <tr>
      <td align="center">
          ...
          <tr>
            <td style="background:#f7f4ef;border-radius:0 0 16px 16px;padding:20px 44px;border-top:1px solid rgba(200,169,110,0.18);">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:10px;color:#b09070;letter-spacing:0.05em;">
                Willow Casa Pvt Ltd · SF-204, The Peach Tree Complex, Sushant Lok Phase-1, Sector-43, Gurgaon — 122002
              </p>
            </td>
          </tr>
        ...
        await transporter.sendMail({
            from: `"Willow Casa Website" <${process.env.SMTP_FROM}>`,
        ...
        await transporter.sendMail({
            from: `"Willow Casa" <${process.env.SMTP_FROM}>`,
            to: email,
            subject: `We received your enquiry — Willow Casa`,
            html: `
<!DOCTYPE html>
<html lang="en">
<body style="margin:0;padding:0;background:#f7f4ef;font-family:'Georgia',serif;">
        ...
        <tr>
          <td style="background:#ffffff;padding:36px 44px;">
            ...
            <p style="font-family:Georgia,serif;font-size:15px;color:#2c2318;line-height:1.8;margin:0 0 20px;">
              ...
              <a href="https://instagram.com/willowcasa" style="color:#c8a96e;">@willowcasa</a>
              or WhatsApp us at
              <a href="https://wa.me/919873255071" style="color:#c8a96e;">+91 98732 55071</a>.
            </p>
            <p style="font-family:Arial,sans-serif;font-size:13px;color:#a08060;margin:0;">
              Warm regards,<br/>
              <strong style="color:#2c2318;">Willow Casa Team</strong>
            </p>
          </td>
        </tr>
        <tr>
          <td style="background:#f7f4ef;border-radius:0 0 16px 16px;padding:20px 44px;">
            <p style="margin:0;font-family:Arial,sans-serif;font-size:10px;color:#b09070;">
              Willow Casa Pvt Ltd · Architecture · Interiors · Turnkey · Landscape
            </p>
          </td>
        </tr>
      </table>
